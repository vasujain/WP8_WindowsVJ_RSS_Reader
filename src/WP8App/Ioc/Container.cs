...
namespace WPAppStudio.Ioc
{
    ...
    public class Container : IContainer
    {
        ...
        public Container()
        {
            ...
            _currentContainer.RegisterType<ILatestPosts_NewsViewModel, LatestPosts_NewsViewModel>();
            _currentContainer.RegisterType<IAboutUsViewModel, AboutUsViewModel>();
			
			if (!System.ComponentModel.DesignerProperties.IsInDesignTool)
            {
				_currentContainer.RegisterType<IRSSDataSource, RSSDataSource>(new ContainerControlledLifetimeManager());
			}
			else
			{
				_currentContainer.RegisterType<IRSSDataSource, FakeRSSDataSource>(new ContainerControlledLifetimeManager());
