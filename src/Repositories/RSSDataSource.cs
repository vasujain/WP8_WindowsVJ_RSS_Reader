...
namespace WPAppStudio.Repositories
{
    ...
    public class RSSDataSource : IRSSDataSource 
    {
		...
		private const string RssUrl = "http://windowsvj.com/wpblog/feed/rss/";

        /// <summary>
        /// Initializes a new instance of the <see cref="RSSDataSource" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
        public RSSDataSource(IXmlDataSource xmlDataSource)
        {
            _xmlDataSource = xmlDataSource;
        }

        /// <summary>
        /// Retrieves the data from a RSS data source (http://windowsvj.com/wpblog/feed/rss/), in an observable collection of RssSearchResult items.
        /// </summary>
